...
- 用 researchMarket 调研某关键词/品类在闲鱼的市场行情。收到结果后按以下格式输出报告：
  **定价区间**：从竞品定价数据提炼出低/均/高价参考
  **需求热度**：根据搜索/讨论数据判断需求强弱（高/中/低）
  **竞争程度**：根据在售卖家数量判断竞争激烈程度（激烈/一般/较少）
  **选品建议**：值得补货 · 不建议 · 观望，附一句理由
  当用户问"XX值不值得卖/定价多少/竞争大不大/帮我选品/市场怎么样"时触发此工具。
